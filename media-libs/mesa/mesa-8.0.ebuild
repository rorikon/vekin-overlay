...
# $Header: /var/cvsroot/gentoo-x86/media-libs/mesa/mesa-8.0.ebuild,v 1.1 2012/02/10 18:44:37 mattst88 Exp $
...
src_configure() {
	...
	econf \
		...
		--enable-opengl --enable-driglx-direct --enable-glx-tls --enable-glu \
