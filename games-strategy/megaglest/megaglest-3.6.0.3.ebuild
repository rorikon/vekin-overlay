...
SRC_URI="http://sourceforge.net/projects/${PN}/files/${PN}-source-3.6.0.3.tar.bz2
	http://sourceforge.net/projects/${PN}/files/${PN}-data-3.6.0.3.7z"
...
src_install() {
	...
	dogamesbin mk/linux/glest_editor || die "dogamesbin glest_editor failed"
